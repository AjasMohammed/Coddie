    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Fetch languages and problem in parallel
                const [languagesRes, problemRes] = await Promise.all([
                    languagesAPI.list(),
                    problemsAPI.get(slug!),
                ]);

                const languagesData = languagesRes.data;
                const problem: Problem = problemRes.data;

                setLanguages(languagesData);

                // Convert test cases from arrays to strings for form
                const testCasesForm: TestCaseForm[] = problem.test_cases.map(
                    (tc: TestCase) => ({
                        input: formatInputArray(tc.input),
                        output: formatOutputValue(tc.output),
                    })
                );
                ...
                setFormData({
                    ...
                    time_limit: problem.time_limit || null,
                    memory_limit: problem.memory_limit || null,
                    function_name: problem.function_name,
                    return_type: problem.return_type,
                    language: problem.language?.id || "",
                    starter_code: problem.starter_code || "",
                    test_cases: testCasesForm.length > 0 ? testCasesForm : [{ input: "", output: "" }],
        ...
        try {
            ...
            setError(
                err.response?.data?.detail ||
                    err.response?.data?.error ||
                    "Failed to update problem. Please check your inputs."
            );
        } finally {
            setSaving(false);
        }
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <FieldLabel
                                            htmlFor="title"
                                            required
                                            tooltip="The title of your problem. This will be displayed in problem lists and used to generate a unique URL slug."
                                        >
                                            Title
                                        </FieldLabel>
                                        <input
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <FieldLabel
                                                htmlFor="language"
                                                required
                                                tooltip="The programming language this problem is designed for."
                                            >
                                                Language
                                            </FieldLabel>
                                            <select
                                        ...
                                        <div>
                                            <FieldLabel
                                                htmlFor="difficulty"
                                                tooltip="The difficulty level of the problem."
                                            >
                                                Difficulty
                                            </FieldLabel>
                                            <select
                                ...
                                <div>
                                    <FieldLabel
                                        htmlFor="description"
                                        required
                                        tooltip="A detailed description of the problem. Use Markdown formatting."
                                    >
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <FieldLabel
                                                    ...
                                                    tooltip="Maximum memory usage in megabytes."
                                                >
                                                    Memory Limit (MB)
                                                </FieldLabel>
                                                <input
                                            ...
                                            <div className="col-span-2">
                                                <FieldLabel
                                                    htmlFor="is_public"
                                                    tooltip="Whether the problem is visible to all users."
                                                >
                                                    Visibility
                                                </FieldLabel>
                                                <select
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                <FieldLabel
                                                    ...
                                                    required
                                                    tooltip="The name of the function that users need to implement."
                                                >
                                            ...
                                            <div>
                                                <FieldLabel
                                                    htmlFor="return_type"
                                                    required
                                                    tooltip="The data type that the function must return."
                                                >
                                                    Return Type
                                                </FieldLabel>
                                                <select
...
"[3,3], 6","[0,1]"`}
                                                ...
                                                >
                                                    ...
                                                    <div className="space-y-3">
                                                        <div>
                                                            <FieldLabel
                                                                required
                                                                tooltip="The input values for this test case."
                                                            >
                                                        ...
                                                        <div>
                                                            <FieldLabel
                                                                required
                                                                tooltip="The expected output for this test case."
                                                            >
                                                                <span className="text-xs">
                                                                    Output
                                                                </span>
                            ...
                            <div className="lg:sticky lg:top-6">
                                <FieldLabel tooltip="The initial code template that users will see.">
                                    Starter Code
                                </FieldLabel>
                                <div
                        ...
                        <div className="pt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    type="submit"
                                    disabled={saving}
                                    className="flex-1 btn-primary py-3 text-base font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                                >
